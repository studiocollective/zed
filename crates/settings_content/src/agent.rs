...
/// Agent settings that may be overridden on a per-project basis via a
/// project's `.zed/settings.json`, in addition to the user's global settings.
#[with_fallible_options]
#[derive(Clone, PartialEq, Serialize, Deserialize, JsonSchema, MergeFrom, Debug, Default)]
pub struct ProjectAgentSettingsContent {
...
pub struct AgentSettingsContent {
    ...
    #[serde(flatten)]
    pub project: ProjectAgentSettingsContent,
